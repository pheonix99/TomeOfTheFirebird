...
namespace TomeOfTheFirebird.New_Spells
{
    class ElementalShieldSpells
    {
        public static void Build()
        {
            ...
            FireShieldWarmBuilder.SetSavingThrowText(new Kingmaker.Localization.LocalizedString()).SetDurationText(LocalizedStrings.OneRoundPerLevelDuration);
            FireShieldColdBuilder.SetRange(AbilityRange.Personal).AllowTargeting(friends: true, self: true).SetAnimationStyle(Kingmaker.Visual.Animation.Kingmaker.Actions.UnitAnimationActionCastSpell.CastAnimationStyle.Self).SetMetamagics(Metamagic.Quicken, Metamagic.Extend, Metamagic.Heighten, Metamagic.CompletelyNormal);
            FireShieldColdBuilder.SetSavingThrowText(new Kingmaker.Localization.LocalizedString()).SetDurationText(LocalizedStrings.OneRoundPerLevelDuration);
            ...
            VitrolicMistBuilder.SetSavingThrowText(new Kingmaker.Localization.LocalizedString()).SetDurationText(LocalizedStrings.OneRoundPerLevelDuration);
