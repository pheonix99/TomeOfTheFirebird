...
namespace TomeOfTheFirebird.New_Spells
{
    class SpearOfPurity
    {
        public static void BuildSpearOfPurity()
        {
            ...
            builder.SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionDirectional);
            ...
            var act = ActionsBuilder.New().Conditional(ConditionsBuilder.New().Alignment(Kingmaker.Enums.AlignmentComponent.Evil, false), ifEvil, ifNotEvil);
