...
namespace TomeOfTheFirebird.New_Content.Spells
{
    public static class HealMount
    {
        public static void Build()
        {
            ...
            healMount.SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionTouch);
            ...
            healmountcastmaker.SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionTouch);
