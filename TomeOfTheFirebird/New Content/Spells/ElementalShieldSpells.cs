...
namespace TomeOfTheFirebird.New_Spells
{
    class ElementalShieldSpells
    {
        public static void Build()
        {
            ...
            FireShieldWarmBuilder.SetRange(AbilityRange.Personal).AllowTargeting(friends: true, self: true).SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionSelf).SetAvailableMetamagic(Metamagic.Quicken, Metamagic.Extend, Metamagic.Heighten, Metamagic.CompletelyNormal);
          
            FireShieldColdBuilder.SetRange(AbilityRange.Personal).AllowTargeting(friends: true, self: true).SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionSelf).SetAvailableMetamagic(Metamagic.Quicken, Metamagic.Extend, Metamagic.Heighten, Metamagic.CompletelyNormal);

            VitrolicMistBuilder.SetRange(AbilityRange.Personal).AllowTargeting(friends: true, self: true).SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionSelf).SetAvailableMetamagic(Metamagic.Quicken, Metamagic.Extend, Metamagic.Heighten, Metamagic.CompletelyNormal);
            ...
            rootFireShieldBuilder.SetRange(AbilityRange.Personal).AllowTargeting(friends: true, self: true).SetAnimationStyle(Kingmaker.View.Animation.CastAnimationStyle.CastActionSelf).SetAvailableMetamagic(Metamagic.Quicken, Metamagic.Extend, Metamagic.Heighten, Metamagic.CompletelyNormal);
