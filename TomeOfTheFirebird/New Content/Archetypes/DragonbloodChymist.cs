...
{
    class DragonbloodChymist
    {
        /*
         * 
         * For alchemists, the key to effective mixtures lies in potent ingredients, and what could be more formidable than the blood of wyrms? Dragonblood chymists specialize in the reckless distillation of extracts and elixirs that allow them to experience the might of a dragon, however dangerous it might be.
...
This ability replaces poison resistance, poison use, and swift poisoning.
        ...
        //Note needs to be unsucked:
        //stock dragon mutagen trades three discoveres for free *nerfed* feral mutagen, free *nerfed* greater/grand (lower mainstat bonus *and* no secondary stat bonus in exchange for no malus - net stat shift is the same for base-teir, but for greater regular is up by 2 and and grand is up by 6. RAW no Feral Wings or bonespike either. Also no True Mutagen
        //Solution: Greater/Grand Dragonic mutagen that up the net stat shift to match stock. 4/0/2 -> 6/2/4 -> 8/4/6
        //Enable all mutagen uprgrades
        //Losing throw anything for always-on breath weapon is saccing a feat for a side-grade of what you always have ... that locks out so many options it's not funny
        //Solution: Treat breath-bomb as basic. No shape-changes and nothing that don't make sense as breath but all the one-only bomb-mods are allowed.
    }
}
